package program.ui.windows.main;
...
import program.ui.elements.combo_box.CustomComboBox;
...
public class Window extends JFrame {
    ...
    private static final ArrayList<NodeInformationWindow> nodeInfoWindows = new ArrayList<>();
...
//        this.add(new Program.UI.Windows.TopBar.TopBar(1700, ""),getGbc(0,0,1,10,1,0.1));
        ...
        themeSwitchPanel.add(new SwitchButton(Palette.DARK_SWITCH_THEME_BUTTON_BACKGROUND, Palette.LIGHT_SWITCH_THEME_BUTTON_BACKGROUND, 30, darkModeEnabled) {
            ...
            public void buttonPressed() {
                ...
                Window.nodeInfoWindows.forEach(NodeInformationWindow::changeTheme);
            }
        });
    ...
    public static ArrayList<NodeInformationWindow> getNodeInfoWindows() {
