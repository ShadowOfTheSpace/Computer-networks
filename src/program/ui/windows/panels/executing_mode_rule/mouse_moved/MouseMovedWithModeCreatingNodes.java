...
public class MouseMovedWithModeCreatingNodes extends MouseActionMode implements Executable {

    public MouseMovedWithModeCreatingNodes(List<Node> nodes, List<Line> lines, Metric metric, MouseEvent event) {
    ...
    public void execute() {
        ...
        if (currentNode.exists() || (currentLine.exists() && event.isControlDown())) {
