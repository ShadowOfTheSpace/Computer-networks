...
public class MouseMovedWithModeFindingPath extends MouseActionMode implements Executable {

    public MouseMovedWithModeFindingPath(List<Node> nodes, List<Line> lines, Metric metric, MouseEvent event) {
