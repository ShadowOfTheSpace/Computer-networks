...
public class MouseMovedWithModeCreatingLines extends MouseActionMode implements Executable {

    public MouseMovedWithModeCreatingLines(List<Node> nodes, List<Line> lines, Metric metric, MouseEvent event) {
    ...
    public void execute() {
        ...
        if (currentNode.exists() || currentLine.exists()) {
